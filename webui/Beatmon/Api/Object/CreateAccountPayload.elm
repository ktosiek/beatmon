...
module Beatmon.Api.Object.CreateAccountPayload exposing (AccountEdgeOptionalArguments, account, accountEdge, clientMutationId, query, selection)
...
-}
selection : (a -> constructor) -> SelectionSet (a -> constructor) Beatmon.Api.Object.CreateAccountPayload
...
-}
clientMutationId : Field (Maybe String) Beatmon.Api.Object.CreateAccountPayload
clientMutationId =
...
-}
account : SelectionSet decodesTo Beatmon.Api.Object.Account -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateAccountPayload
account object_ =
...
-}
query : SelectionSet decodesTo RootQuery -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateAccountPayload
query object_ =
...
-}
accountEdge : (AccountEdgeOptionalArguments -> AccountEdgeOptionalArguments) -> SelectionSet decodesTo Beatmon.Api.Object.AccountsEdge -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateAccountPayload
