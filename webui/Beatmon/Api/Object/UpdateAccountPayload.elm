...
module Beatmon.Api.Object.UpdateAccountPayload exposing (AccountEdgeOptionalArguments, account, accountEdge, clientMutationId, query, selection)
...
-}
selection : (a -> constructor) -> SelectionSet (a -> constructor) Beatmon.Api.Object.UpdateAccountPayload
...
-}
clientMutationId : Field (Maybe String) Beatmon.Api.Object.UpdateAccountPayload
clientMutationId =
...
-}
account : SelectionSet decodesTo Beatmon.Api.Object.Account -> Field (Maybe decodesTo) Beatmon.Api.Object.UpdateAccountPayload
account object_ =
...
-}
query : SelectionSet decodesTo RootQuery -> Field (Maybe decodesTo) Beatmon.Api.Object.UpdateAccountPayload
query object_ =
...
-}
accountEdge : (AccountEdgeOptionalArguments -> AccountEdgeOptionalArguments) -> SelectionSet decodesTo Beatmon.Api.Object.AccountsEdge -> Field (Maybe decodesTo) Beatmon.Api.Object.UpdateAccountPayload
