...
module Beatmon.Api.Object.CreateHeartbeatPayload exposing (HeartbeatEdgeOptionalArguments, accountByAccountId, clientMutationId, heartbeat, heartbeatEdge, query, selection)
...
-}
selection : (a -> constructor) -> SelectionSet (a -> constructor) Beatmon.Api.Object.CreateHeartbeatPayload
...
-}
clientMutationId : Field (Maybe String) Beatmon.Api.Object.CreateHeartbeatPayload
clientMutationId =
    Object.fieldDecoder "clientMutationId" [] (Decode.string |> Decode.nullable)


{-| The `Heartbeat` that was created by this mutation.
-}
heartbeat : SelectionSet decodesTo Beatmon.Api.Object.Heartbeat -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateHeartbeatPayload
heartbeat object_ =
...
-}
query : SelectionSet decodesTo RootQuery -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateHeartbeatPayload
query object_ =
...
-}
accountByAccountId : SelectionSet decodesTo Beatmon.Api.Object.Account -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateHeartbeatPayload
...
-}
heartbeatEdge : (HeartbeatEdgeOptionalArguments -> HeartbeatEdgeOptionalArguments) -> SelectionSet decodesTo Beatmon.Api.Object.HeartbeatsEdge -> Field (Maybe decodesTo) Beatmon.Api.Object.CreateHeartbeatPayload
